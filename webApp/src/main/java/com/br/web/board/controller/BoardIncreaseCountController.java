...
/**
 * Servlet implementation class BoardIncreaseCountController
 */
@WebServlet("/increase.bo")
public class BoardIncreaseCountController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardIncreaseCountController() {
        super();
